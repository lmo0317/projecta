                ...
                else
                {
                    ...
                    if (set.LimitMode == OStamperMultiSet.MultiStamperSetParameters.ECountLimit.LimitPerPrefab)
                    {
                        ...
                        for (int i = 0; i < set.TargetSet.Prefabs.Count; i++)
                        {
                            ...
                            if (set.TargetSet.Prefabs[i].Prefab == null) continue;
                            toInclude.Add(set.TargetSet.Prefabs[i].Prefab);
                        }
                        ...
                        for (int i = Get.PerPrefabSettings.Count - 1; i >= 0; i--)
                        {
                            ...
                            if (toInclude.Contains(Get.PerPrefabSettings[i].Prefab)) toInclude.Remove(Get.PerPrefabSettings[i].Prefab);
                        }
