                ...
                if (spawningInfo.ChoosedPrefab != null)
                {
                    ...
                    if (prr != null)
                        if (prr.GetMesh() != null)
                        {
                            ...
                            Vector3 scale = Vector3.one; if (prr.Prefab) scale = prr.Prefab.transform.localScale;
                ...
                if (h.transform)
                {
                    ...
                    if (spawnPrefabRef != null)
                        if (spawnPrefabRef.GetMesh() != null)
                        {
                            ...
                            Vector3 scale = Vector3.one; if (spawnPrefabRef.Prefab) scale = spawnPrefabRef.Prefab.transform.localScale;
