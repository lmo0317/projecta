...
namespace FIMSpace.Generating.Rules.Placement
{
    public class SR_CellPosition : SpawnRuleBase, ISpawnProcedureType
    {
        ...
        [HideInInspector] public SpawnerVariableHelper ValueMulVariable = new SpawnerVariableHelper(FieldVariable.EVarType.Float);
        ...
        {
            base.NodeBody(so);
            ValueMulVariable.requiredType = FieldVariable.EVarType.Float;
        }
#endif
        #endregion
