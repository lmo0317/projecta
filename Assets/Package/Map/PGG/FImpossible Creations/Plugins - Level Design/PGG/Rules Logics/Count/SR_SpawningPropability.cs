...
namespace FIMSpace.Generating.Rules.Count
{
    public class SR_SpawningPropability : SpawnRuleBase, ISpawnProcedureType
    {
        ...
        public SpawnerVariableHelper PropabilityMulVariable = new SpawnerVariableHelper(FieldVariable.EVarType.Float);
        ...
        {
            base.NodeBody(so);
            PropabilityMulVariable.requiredType = FieldVariable.EVarType.Float;
        }
#endif
        #endregion
