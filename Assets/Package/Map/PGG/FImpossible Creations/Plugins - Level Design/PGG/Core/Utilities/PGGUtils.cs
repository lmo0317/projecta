...
namespace FIMSpace.Generating
{
    public static class PGGUtils
    {
        ...
        internal static void TransferFromListToList<T>(List<T> from, List<T> to, bool checkForDuplicates = false)
        {
        ...
        internal static void CheckForNulls<T>(List<T> classes)
        {
        ...
        internal static void CheckForNullsO<T>(List<T> objects) where T : UnityEngine.Object
        {
