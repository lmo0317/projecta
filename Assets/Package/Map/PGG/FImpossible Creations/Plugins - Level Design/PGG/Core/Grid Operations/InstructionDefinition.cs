...
namespace FIMSpace.Generating
{
    ...
    public class InstructionDefinition
    {
        ...
        public enum EInstruction { None, DoorHole, PreRunModificator, PostRunModificator, PreventAllSpawn, PreventSpawnSelective, InjectStigma, InjectDataString, IsolatedGrid/*, Custom*/ }
