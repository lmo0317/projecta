...
namespace FIMSpace.Generating.Checker
{
    public partial class CheckerField
    {
        ...
        void CheckGraphForNearestMargins(CheckerField grid, int maxCells, CheckerPos root, ref CheckerPos px, ref CheckerPos nx, ref CheckerPos pz, ref CheckerPos nz)
        {
