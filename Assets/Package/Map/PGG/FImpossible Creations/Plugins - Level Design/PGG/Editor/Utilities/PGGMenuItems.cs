...
namespace FIMSpace.Hidden
{
    public static class PGGMenuItems
    {
        ...
        [MenuItem("Assets/Create/FImpossible Creations/Procedural Generation/Scripting Templates/Create Spawn Rule Script Template", false, 1000)]
        ...
        [MenuItem("Assets/Create/FImpossible Creations/Procedural Generation/Scripting Templates/Create Spawn Rule Script Template (Empty)", false, 1001)]
        ...
        [MenuItem("Assets/Create/FImpossible Creations/Procedural Generation/Scripting Templates/Create Custom Generator Script", false, 1002)]
        ...
        [MenuItem("Window/FImpossible Creations/Level Design/PGG Video Tutorials...", false, 1003)]
        ...
        [MenuItem("Window/FImpossible Creations/Level Design/PGG Manual...", false, 1004)]
