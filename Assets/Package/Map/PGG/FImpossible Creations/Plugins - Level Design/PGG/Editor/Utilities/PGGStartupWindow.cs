...
#if UNITY_2019_1_OR_NEWER
#else
            if (GUILayout.Button("Info for Unity 2017-2018 Users"))
            {
                EditorUtility.DisplayDialog("Dear Unity 2017-2018 Users", "Unfortunatelly Unity does not support back compatibility for prefabs on Unity 2018 or lower.\nSince examples database is so big (258 prefabs) I can't afford another weeks of making example assets,\nso please consider using Unity 2019.4 + for demo scenes as learning version.", "Ok");
            }
#endif
