...
namespace FIMSpace.Generating.Checker
{
    public partial class CheckerField
    {
        ...
        {
            List<Vector2Int> pathPoints = GeneratePathFindPoints(from, to, dirChangeCost);
        ...
        public static List<Vector2Int> GeneratePathFindPoints(Vector2Int start, Vector2Int end, float changeDirectionCost = 0.1f)
        {
