                ...
                if (CellExists(myPos + QuartDir(1)))
                    if (CellExists(myPos + QuartDir(2)))
                        if (CellExists(myPos + QuartDir(3)))
                        {
                            if (includeDiagonal)
                            {
                                if (CellExists(myPos + QuartDir(0) + QuartDir(1)))
                                    if (CellExists(myPos + QuartDir(1) + QuartDir(2)))
                                        if (CellExists(myPos + QuartDir(2) + QuartDir(3)))
                                            if (CellExists(myPos + QuartDir(3) + QuartDir(0)))
                                                return true;
                            }
                            else
                                return true;
