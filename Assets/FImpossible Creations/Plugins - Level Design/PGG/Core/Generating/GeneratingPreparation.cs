...
namespace FIMSpace.Generating
{
    ...
    public class GeneratingPreparation
    {
        ...
        public FieldSetup RuntimeFieldSetup { get { if (runtimeFieldSetup == null) runtimeFieldSetup = ParentFieldSetup.GenerateRuntimeInstance(); return runtimeFieldSetup; } }
        ...
        [HideInInspector] /*[SerializeField] */private FieldSetup runtimeFieldSetup;
        ...
        public void BEGIN_SetReferences(FlexibleGeneratorSetup flex)
        {
            ...
            {
                runtimeFieldSetup = ParentFieldSetup.GenerateRuntimeInstance();
            }
