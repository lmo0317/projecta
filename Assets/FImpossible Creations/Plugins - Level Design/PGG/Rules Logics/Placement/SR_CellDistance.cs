...
namespace FIMSpace.Generating.Rules.Placement
{
    public class SR_CellDistance : SpawnRuleBase, ISpawnProcedureType
    {
        ...
        public SpawnerVariableHelper DistanceMulVariable = new SpawnerVariableHelper(FieldVariable.EVarType.Float);
        ...
        public override void NodeBody(SerializedObject so)
        {
            ...
            if (DistanceMulVariable != null) DistanceMulVariable.requiredType = FieldVariable.EVarType.Float;
