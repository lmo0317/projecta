...
namespace FIMSpace.Generating.Rules.Count
{
    public class SR_LimitSpawnCount : SpawnRuleBase, ISpawnProcedureType
    {
        ...
        [HideInInspector] public SpawnerVariableHelper CountMulVariable = new SpawnerVariableHelper(FieldVariable.EVarType.Float);
        ...
        public override void NodeBody(SerializedObject so)
        {
            ...
            if (CountMulVariable != null) CountMulVariable.requiredType = FieldVariable.EVarType.Float;
