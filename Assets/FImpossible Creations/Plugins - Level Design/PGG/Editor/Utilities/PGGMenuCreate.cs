...
namespace FIMSpace.Hidden
{
    public static class PGGMenuCreate
    {
        ...
        [MenuItem("GameObject/Generators/Facility Generator", false, 2)]
        static void CreateFacilityGeneratorObject()
        {
            GameObject go = new GameObject();
            go.name = "Facility Generator";
            go.AddComponent<FacilityGenerator>();
